...
class AuthenticationTest(TestCase):
    ...
    def test_user_login(self):
        ...
        self.assertTemplateUsed(response, 'smthfortest/templates/smthfortest/login_user.html')

    def test_user_registration(self):
        response = self.client.get(reverse('register'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'smthfortest/templates/smthfortest/register_user.html')
...
class ThingstodoListViewTest(TestCase):
    ...
    def test_new_task_uses_correct_template(self):
        ...
        self.assertTemplateUsed(response, 'smthfortest/templates/smthfortest/new_task.html')
